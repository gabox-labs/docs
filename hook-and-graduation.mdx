...
<Note>
The hook is implemented in the current source tree. The latest recorded devnet deployment predates that source change. See [status](/status-and-addresses) before assuming it is live.
</Note>
